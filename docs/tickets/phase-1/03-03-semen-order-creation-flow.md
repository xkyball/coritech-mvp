# Ticket 3.3 — Create Semen Order creation flow
...
```text
Implement the Semen Order creation flow for CoriTech breeders. Use a multi-step or clear single-page form: listing review, delivery date, shipping details, instructions, review and submit. Validate required fields, create draft, submit order and show confirmation with order number.
```

## Recommended Codex Wrapper Prompt
```text
Implement Ticket 3.3 — Create Semen Order creation flow.
