# Ticket 9.1 — Integrate email notification provider
...
```text
Integrate an email notification provider for CoriTech. Create a NotificationService with templates for order submitted, received, confirmed, rejected, shipment created, shipment updated, document uploaded and admin action required. Add delivery logging and environment config.
```

## Recommended Codex Wrapper Prompt
```text
Implement Ticket 9.1 — Integrate email notification provider.
