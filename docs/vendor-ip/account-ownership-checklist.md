...
| Managed auth provider account | Yes | `[PENDING_VENDOR_SELECTION]` | CoriTech | `[PENDING_CORITECH_ADMIN]` | `[PENDING_BACKUP_ADMIN]` | Tenant owner export, admin list, domain/app client settings, recovery settings | `[PENDING_VENDOR_SELECTION]` |
